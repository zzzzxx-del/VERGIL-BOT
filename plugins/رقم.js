...
let handler = async (m, { conn, text, command, usedPrefix }) => {
    ...
    let pp = 'https://telegra.ph/file/16fdc400418388e3cb20c.jpg';
    ...
    if (!lister.includes(feature)) {
        return conn.sendButton(m.chat, cap, 'VERGIL BOT', pp, [['دولـة',`${usedPrefix + command} دولة`]], null, null, m);
    }
...
return await conn.relayMessage(m.chat, msg.message, { messageId: msg.key.id });
            ...
            console.log(error);
            return conn.sendButton(m.chat, `╮────────────────────────╭ـ\n│ حدث خطأ أثناء جلب البيانات. حاول مرة أخرى لاحقًا.\n╯────────────────────────╰ـ `, 'VERGIL BOT', pp, [['حاول مجددا',`${usedPrefix + command} أرقام ${additionalLink}`]], null, null, m);
        }
      ...
      interactiveMessage: {
        ...
        nativeFlowMessage: {
          ...
          messageParamsJson: "",
            ...
            console.log(error);
            return conn.sendButton(m.chat, `╮────────────────────────╭ـ\n│ حدث خطأ أثناء جلب البيانات. حاول مرة أخرى لاحقًا.\n╯────────────────────────╰ـ `, 'VERGIL BOT', pp, [['حاول مجددا',`${usedPrefix + command} رسائل ${additionalLink}`]], null, null, m);
        }
...
conn.sendButton(m.chat, caption, 'VERGIL BOT', pp, [['الرئيسية',`${usedPrefix + command}`]], null, null, m);
    }
};
